...
function LogSession( sessionData, redisStore ) {
  if( !sessionData )
  ...
  eventEmitter.on(this.getPubNamespace(), this.handleIncommingLogMessage.bind(this) )
...
LogSession.prototype.handleIncommingLogMessage = function( logMessage ) {

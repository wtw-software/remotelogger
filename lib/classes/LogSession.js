var redis                 = require( 'redis' ),
    async                 = require( 'async' ),
    LogSessionSyncStream  = require( './LogSessionSyncStream' ),
...
LogSession.getSyncStream = function() {
  var syncStream = new LogSessionSyncStream()
  return syncStream
}
...
LogSession.prototype.publishEvent = function( eventName, data ) {
  var event, eventObject, dataString
  try {

    event = "logSession::" + this.getPubSubNamespace() + "::" + eventName
    eventObject = {
      logSessionId: LogSession.parseObjectId(this),
      event: eventName,
      data: data
    }

    dataString = JSON.stringify( eventObject )
...
LogSession.prototype.emitPushLogMessage = function( logMessage ) {
  var message
...
LogSession.prototype.emitAddLogSession = function() {
  this.publishEvent( 'addLogSession', this )
}


LogSession.prototype.emitConsoleLoad = function() {
  this.publishEvent( 'consoleLoad', this )
}
